...
export namespace Logger {
    ...
    export const info = (data: string) => {
        // Performance Mode: skip non-essential logging entirely - avoids the
        // array copy + MMKV persist write that addLog does on every call.
        // Warnings/errors/toasts are untouched so real problems still surface.
